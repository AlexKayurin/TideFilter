...
class MainWindow(QtWidgets.QMainWindow, _UI_Control.Ui_MainWindow):
    def __init__(self):
        ...
        self.b_Yup.clicked.connect(self.scale_change)
        self.b_Ydown.clicked.connect(self.scale_change)
        self.b_Yall.clicked.connect(self.scale_change)
    ...
    def mouse_moved(self, e):
        ...
        if self.alignflag and self.alignpoint % 2 == 1:
            self.align_line.setData(x=[self.gap_start[0], self.cursor.x()],
    ...
    def plot_reject_rect(self):
        ...
        self.reject_rect.setData(x=[-self.h_span, -self.h_span, self.h_span, self.h_span, -self.h_span],
    ...
    def reject_btn_pressed(self):
        ...
        if self.rejectflag:
            ...
            self.reject_rect.setVisible(True)
    ...
    def align_btn_pressed(self):
        ...
        if self.alignflag:
            ...
            self.b_run.setEnabled(False)
            self.b_export.setEnabled(False)
            self.align_start.setVisible(True)
            self.align_line.setVisible(True)
            ...
            self.b_export.setEnabled(True)
            self.align_start.setVisible(False)
            self.align_start.setData([], [])
            self.align_line.setVisible(False)
            self.align_line.setData([], [])
    ...
    def plotdata(self):
        self.tidecurve.setData(x=self.tide['Timestamp_shifted'], y=self.tide['Tide_shifted'])
        self.tidecurvesub.setData(x=self.tidesub['Timestamp_shifted'], y=self.tidesub['Tide_shifted'])
        self.flt.setData(x=self.tidesub['Timestamp_shifted'], y=self.tidesub['Tide_filtered'])
